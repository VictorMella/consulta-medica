...
Public Class Receta
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        Me.Rut_Med_Receta.Text = Session("Rut")

        txtFicheroPDF.Text = System.IO.Path.Combine(System.Environment.GetFolderPath(Environment.SpecialFolder.Desktop), nom.Text & ";" & Session("Remedio") & ".pdf")
    ...
    Protected Sub BTN_GuardarReceta_Click(sender As Object, e As EventArgs) Handles BTN_GuardarReceta.Click
        ...
        End If
        cmbRemedio.SelectedIndex = 0

        objmedico.GuardarReceta(Fecha_Receta.Text, rut.Text, Rut_Med_Receta.Text, TxtTratamiento.Text)
        MsgBox("La Receta se ha Guardado Correctamente")
        Dim dtreceta As DataTable = New MedicoCls().BuscarReceta(rut.Text)
        If dtreceta.Rows.Count() > 0 Then
            Session("Remedio") = dtreceta(0).Item("Id Receta")
        End If
        Me.receta.InnerHtml = "Tu numero de Receta es el " & Session("Remedio")
        objmedico = New MedicoCls
    ...
    Protected Sub Btn_Imprimir_Click(sender As Object, e As EventArgs) Handles Btn_Imprimir.Click
        ...
        Else
            Try
                ...
                Dim parrafo3 = New Paragraph("Colo-Colo 379 - Of.513 - Fono: 41 2243882", FontFactory.GetFont(FontFactory.TIMES, 11, iTextSharp.text.Font.NORMAL))
                Dim parrafo4 = New Paragraph("I.C.M. " & Session("icm") & " -  RUT: " & Rut_Med_Receta.Text, FontFactory.GetFont(FontFactory.TIMES_ITALIC, 11, iTextSharp.text.Font.NORMAL))
                ...
                Dim footer3 = New Paragraph("RUT: " & Rut_Med_Receta.Text, FontFactory.GetFont(FontFactory.TIMES_ITALIC, 11, iTextSharp.text.Font.NORMAL))
                ...
                Dim DOC = New Paragraph("Receta Medica.", FontFactory.GetFont(FontFactory.TIMES_ITALIC, 15, iTextSharp.text.Font.NORMAL))
                ...
                'linea 0
                documentoPDF.Add(New Paragraph("N° de Receta " & Session("Remedio"), FontFactory.GetFont(FontFactory.TIMES, 14, iTextSharp.text.Font.NORMAL)))
                documentoPDF.Add(Chunk.NEWLINE)

                'linea 1
                documentoPDF.Add(New Paragraph("Fecha de Emision:", FontFactory.GetFont(FontFactory.TIMES, 14, iTextSharp.text.Font.NORMAL)))
                documentoPDF.Add(New Paragraph(Fecha_Receta.Text, FontFactory.GetFont(FontFactory.TIMES, 11, iTextSharp.text.Font.NORMAL)))
                documentoPDF.Add(Chunk.NEWLINE)
                ...
                'linea 5
                documentoPDF.Add(New Paragraph("Indicaciones:", FontFactory.GetFont(FontFactory.TIMES, 14, iTextSharp.text.Font.NORMAL)))
                documentoPDF.Add(New Paragraph(TxtTratamiento.Text, FontFactory.GetFont(FontFactory.TIMES, 11, iTextSharp.text.Font.NORMAL)))
                documentoPDF.Add(Chunk.NEWLINE)
                documentoPDF.Add(Chunk.NEWLINE)
                documentoPDF.Add(Chunk.NEWLINE)
                documentoPDF.Add(Chunk.NEWLINE)
